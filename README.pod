...
I<lemonbar> [-h | -g I<width>B<x>I<height>B<+>I<x>B<+>I<y> | -b | -d | -f I<font> | -p | -n I<name> | -u I<pixel> | -B I<color> | -F I<color> | -U I<color> | -I I<color> | -i I<width> | -o I<offset> ]
...
Set the border width of the bar, in pixels.
